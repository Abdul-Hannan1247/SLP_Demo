...
<head>
    ...
    <style>
        body {
            ...
            background-color: #e0f2f7; /* Light blue background (Material Design Light Blue 50) */
            padding-top: 60px;
            padding-bottom: 30px;
        }
        ...
        h1 {
            color: #1976d2; /* Primary blue color (Material Design Blue 700) */
            margin-bottom: 25px;
            text-align: center;
        }
        ...
        .item-container {
            ...
            height: 150px;
            margin-bottom: 15px;
            border: 1px solid #bbdefb; /* Light blue border (Material Design Blue 100) */
            border-radius: 6px;
            display: flex;
            justify-content: center;
            align-items: center;
            cursor: pointer;
            background-color: #e3f2fd; /* Very light blue background (Material Design Blue 50) */
        ...
        #feedback {
            ...
            font-weight: bold;
            text-align: center;
            color: #2e7d32; /* Green for success (Material Design Green 800) */
        }

        #feedback.error {
            color: #d32f2f; /* Red for error (Material Design Red 700) */
        }

        .no-items {
            text-align: center;
            color: #757575; /* Gray for informational text (Material Design Gray 600) */
        }
    </style>
</head>
                    ...
                    fetch(checkAnswerUrl, {
                        ...
                        .then(data => {
                            ...
                            if (data.correct) {
                                ...
                                setTimeout(() => {
                                    window.location.reload(); // Reload to start a new round
                                }, 1500);
                            } else {
