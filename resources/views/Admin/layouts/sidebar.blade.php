    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                ...
                {{-- Appointments --}}
                <li class="nav-item dropdown {{ request()->routeIs('appointments.create') ? 'active show' : '' }}">
                    <a class="nav-link dropdown-toggle" href="#navbar-appointments" data-bs-toggle="dropdown"
                        data-bs-auto-close="false" role="button"
                        aria-expanded="{{ request()->routeIs('appointments.create') ? 'true' : 'false' }}">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                    ...
                    <div class="dropdown-menu {{ request()->routeIs('appointments.create') ? 'show' : '' }}">
