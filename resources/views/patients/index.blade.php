            ...
            <div class="col-md-12">
                ...
                <div class="d-flex align-items-center">
                    <div class="input-group rounded me-2">
                        <input type="text" name="search" id="searchInput" class="form-control rounded" placeholder="Search Patients..."
            ...
            const updateTable = () => {
                ...
                fetch(url)
                    ...
                    .then(html => {
                        ...
                        document.getElementById('patientsTable').querySelector('tbody').innerHTML = tempDiv.querySelector('#patientsTable tbody').innerHTML;
