                        ...
                        <form method="POST" action="{{ route('patients.update', $patient->id) }}" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input id="name" type="text"
                                            ...
                                            value="{{ old('name', $patient->name) }}" required autocomplete="name" autofocus>
                                        @error('name')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input id="email" type="email"
                                            ...
                                            value="{{ old('email', $patient->email) }}" autocomplete="email">
                                        @error('email')
                                            <span class="invalid-feedback"
                                                role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        <label for="emergency_contact" class="form-label">{{ __('Emergency Contact') }}
                                            <span class="text-danger">*</span></label>
                                        <input id="emergency_contact" type="tel"
                                            class="form-control @error('emergency_contact') is-invalid @enderror"
                                            name="emergency_contact" value="{{ old('emergency_contact', $patient->emergency_contact) }}">
